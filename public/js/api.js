...
const api = {
  ...
  serverSettings: {
    ...
    getApiCallTracking:  ()      => request("GET",  "/server-settings/api-call-tracking"),
    setApiCallTracking:  (on)   => request("PUT",  "/server-settings/api-call-tracking", { enabled: on }),
    getApiCallHistory:   ()     => request("GET",  "/server-settings/api-call-history"),
