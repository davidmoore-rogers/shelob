...
│   │   ├── oidRegistry.ts           # Symbolic name → numeric OID resolver. Loads every uploaded MIB, parses OBJECT-TYPE / OBJECT IDENTIFIER assignments, resolves them against a built-in seed of SMI roots + common vendor enterprise prefixes. Refreshed on MIB upload/delete + at app startup.
