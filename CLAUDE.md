...
- **Before any commit, review CLAUDE.md for updates.** When the user approves a commit, re-read CLAUDE.md and update any sections affected by the change — new models, fields, routes, services, jobs, env vars, or behavior shifts all need their CLAUDE.md entry refreshed in the same commit.
